...
class ItemControllerCommentIT {
    ...
    @Test
    @DisplayName("POST /items/{id}/comment — 201 when past APPROVED booking exists")
    ...
    @Test
    @DisplayName("POST /items/{id}/comment — 400 when user has no past APPROVED bookings")
    ...
    @Test
    @DisplayName("POST /items/{id}/comment — 400 when booking is in the future")
    ...
    @Test
    @DisplayName("POST /items/{id}/comment — 400 on blank text")
    ...
    @Test
    @DisplayName("POST /items/{id}/comment — 400 when X-Sharer-User-Id is missing")
    ...
    @Test
    @DisplayName("GET /items/{id} — comments present and sorted by created ASC")
