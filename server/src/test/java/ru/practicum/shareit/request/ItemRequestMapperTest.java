...
class ItemRequestMapperTest {
    ...
    @Test
    @DisplayName("toResponse(): maps requester(id,name), items, tolerates null requester")
    void toResponse_success_andNullTolerant() {
        ...
        assertAll(
                ...
                () -> assertNotNull(dto1.requester()),
                () -> assertEquals(7L, dto1.requester().id()),
                () -> assertEquals("Ann", dto1.requester().name()),
                ...
                () -> assertNull(dto2.requester(), "requester must be null if requestor is null"),
